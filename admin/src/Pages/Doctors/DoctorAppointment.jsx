    ...
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border border-gray-300 rounded text-sm max-h-[80vh] overflow-y-scroll min-h-[50vh]">
        ...
        {appointment.map((item, index) => (
          <div
            key={index}
            className="flex flex-wrap cursor-pointer justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1.5fr_1fr_2fr_2fr_3fr] gap-1 items-center text-gray-500 py-3 px-6 border-b border-gray-300 hover:bg-blue-50"
          >
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl shadow-xl relative">
            ...
            <form onSubmit={handleSubmitReport} className="flex flex-col gap-3">
              ...
              <label
                ...
                className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-blue-500 rounded-lg cursor-pointer bg-gray-50"
              >
