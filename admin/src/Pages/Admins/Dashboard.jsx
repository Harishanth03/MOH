        ...
        <div className='py-4 border border-blue-500 border-t-0'>

          {
            dashData.latestAppointments.map((item , index) => (
              ...
              <div key={index} className='flex cursor-pointer items-center px-4 py-3 gap-3 hover:bg-blue-50'>
...

                {
                  ...
                  <img onClick={() => cancleAppointment(item._id)} className='w-5' src={assets.delete_icon} alt="" />
                }
