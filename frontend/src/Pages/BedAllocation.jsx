      ...
      {!selectedWard && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {wards.map((ward, idx) => (
            ...
            <div key={idx} onClick={() => setSelectedWard(ward)} className="bg-white p-5 rounded-xl shadow hover:shadow-lg cursor-pointer transition">
        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            {selectedWard.wardNumbers.map((room, idx) => (
              ...
              <div key={idx} onClick={() => setSelectedWardNumber(room)} className="bg-white p-4 rounded-lg shadow cursor-pointer hover:bg-blue-100">
      ...
      {selectedWard && selectedWardNumber && (
        ...
        <>
          ...
          <div className="grid grid-cols-6 gap-4 justify-items-center">
            ...
            {Array.from({ length: selectedWardNumber.beds }).map((_, index) => ( <div key={index} className="w-12 h-12 flex items-center justify-center rounded bg-blue-200 hover:bg-blue-300 text-sm font-semibold cursor-pointer shadow">
