...
const DonationSuccess = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-10">
      <h2 className="text-2xl font-bold text-green-700 mb-4 text-center">Donation Successful!</h2>
      <div className="bg-green-50 border border-green-200 rounded-md p-5 text-gray-800 space-y-3">
