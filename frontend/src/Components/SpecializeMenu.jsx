        ...
        <section id="specialitys" className='w-full mt-6'>
            ...
            <div className='flex flex-wrap justify-center gap-4 my-2 overflow-hidden '>
            {
                specialityData.map((item  , index) => (
                    <Link onClick={() => scrollTo(0,0)} className='w-40 p-4 my-5 bg-gray-100 rounded-md text-center cursor-pointer hover:translate-y-[-10px] transition-all duration-500' key={index} to={`/doctors/${item.speciality}`}>
